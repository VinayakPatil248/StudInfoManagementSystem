			...
			<div class="modal-content">
				<form method="POST" action="update_student.php">	
						...
						<div class="col-md-6">
							...
							<div class="form-inline">
								...
								<select name="section" class="form-control" required="required">
									...
									<option value="BT">Bio-tech Engineering</option>
								</select>
							</div>
							<br />
							<div class="form-group">
					...
					<div class="modal-footer">
						...
						<button name="update" class="btn btn-warning" ><span class="glyphicon glyphicon-refresh"></span> Update</button>
					</div>
				</form>
			</div>
		</div>
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<form method="POST" action="save_student.php">	
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-danger" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Close</button>
						<button name="save" class="btn btn-success" ><span class="glyphicon glyphicon-floppy-disk"></span> Save</button>
					</div>
				</form>
			</div>
		</div>
